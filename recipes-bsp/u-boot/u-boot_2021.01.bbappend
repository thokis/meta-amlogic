...
SRC_URI_append_nosem = " file://0001-meson-env-remove-amlogic-directory-from-fdtfile-vari.patch"

# HDMI and USB Keyboard mess with the TTY and are annoying while working on the platform
SRC_URI_append_nosem = "${@bb.utils.contains('UBOOT_ILOVEUART', '1', " file://meson-config-only-uart-by-default.patch", "", d)}"

# Add p241 support
SRC_URI_append_amlogic-p241 = " file://0001-arm64-meson-import-p241-dts-from-linux-v5.8-rc1.patch \
